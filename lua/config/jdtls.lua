local function get_jdtls()
    local jdtls_path = require("mason.settings").current.install_root_dir .. "/packages/jdtls"
...
local function get_bundles()
    local java_debug_path = require("mason.settings").current.install_root_dir .. "/packages/java-debug-adapter"
    local bundles = {
        vim.fn.glob(java_debug_path .. "/extension/server/com.microsoft.java.debug.plugin-*.jar", 1)
    }
    local java_test_path = require("mason.settings").current.install_root_dir .. "/packages/java-test"
...
local function get_workspace()
    ...
    local workspace_path = home .. "/code/workspaces/"
        ...
        java = {
            ...
            configuration = {
                ...
                runtimes = {
                    {
                        name = "JavaSE-17",
                        path = "~/.sdkman/candidates/java/17.0.17-zulu/"
                    },
                    {
                        name = "JavaSE-21",
                        path = "~/.sdkman/candidates/java/21.0.9-zulu/"
                    },
                    {
                        name = "JavaSE-11",
                        path = "~/.sdkman/candidates/java/11.0.29-zulu/"
                    }
                }
            },
